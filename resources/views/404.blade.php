...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
           ...
           html, body, head, style, html::after, body::after, head::after, style::after, html::before, body::before, head::before, style::before {
  content: '';
...
style, head, head::after, html::after, html::before, body::after {
  position: absolute;
  top: 0;
  left: 0;
  bottom: 0;
